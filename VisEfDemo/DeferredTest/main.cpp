...
int main()
{
    ...
    GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "DeferredTest", nullptr, nullptr); // Windowed
    ...
    Shader shaderGeometryPass("../resource/shaders/gBuffer.vs", "../resource/shaders/gBuffer.frag");
    Shader shaderLightingPass("../resource/shaders/deferredShading.vs", "../resource/shaders/deferredShading.frag");
    Shader shaderLightBox("../resource/shaders/lightBox.vs", "../resource/shaders/lightBox.frag");
    ...
    // Models
    Model cyborg("../resource/nano/nanosuit.obj");
