...
FRMMATRIX4X4 FrmMatrixReflect( FRMMATRIX4X4& matSrcMatrix, FRMVECTOR3& n, FLOAT32 d )
{
    ...
    // Mirror XYZ rotation
    FRMVECTOR3 TempX = x + t;
    FRMVECTOR3 TempY = y + t;
    FRMVECTOR3 TempZ = z + t;
    FRMVECTOR3 mx = x + t - 2 * n * ( FrmVector3Dot( TempX, n ) - d ) - mt;
    FRMVECTOR3 my = y + t - 2 * n * ( FrmVector3Dot( TempY, n ) - d ) - mt;
    FRMVECTOR3 mz = z + t - 2 * n * ( FrmVector3Dot( TempZ, n ) - d ) - mt;
