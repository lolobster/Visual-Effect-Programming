...
// All the typedefs like FLOAT32
#include "frmplatform.h"

//#include <graphics/FrmPlatform.h>
#include <graphics/FrmNoise.h>
...
CFrmPerlin::CFrmPerlin()
{
    for( INT32 i = 0; i < B; i++ )
    {
        ...
        m_g1[i] = RAND / B;
        FRMVECTOR2 Temp2 = FRMVECTOR2(RAND, RAND);
        FRMVECTOR3 Temp3 = FRMVECTOR3(RAND, RAND, RAND);
        Temp2 /= B;
        Temp3 /= B;
        m_g2[i] = FrmVector2Normalize(Temp2);
        m_g3[i] = FrmVector3Normalize(Temp3);
    }
...
FLOAT32 CFrmPerlin::Noise2D( const FLOAT32 x, const FLOAT32 y )
{
    ...
    FRMVECTOR2 Temp00 = FRMVECTOR2(rx0, ry0);
    FRMVECTOR2 Temp01 = FRMVECTOR2(rx0, ry1);
    FRMVECTOR2 Temp10 = FRMVECTOR2(rx1, ry0);
    FRMVECTOR2 Temp11 = FRMVECTOR2(rx1, ry1);
    FLOAT32 a = FrmLerp(sx, FrmVector2Dot(m_g2[b00], Temp00), FrmVector2Dot(m_g2[b10], Temp10));
    FLOAT32 b = FrmLerp(sx, FrmVector2Dot(m_g2[b01], Temp01), FrmVector2Dot(m_g2[b11], Temp11));
...
FLOAT32 CFrmPerlin::Noise3D( const FLOAT32 x, const FLOAT32 y, const FLOAT32 z )
{
    ...
    FRMVECTOR3 Temp000 = FRMVECTOR3(rx0, ry0, rz0);
    FRMVECTOR3 Temp001 = FRMVECTOR3(rx0, ry0, rz1);
    FRMVECTOR3 Temp010 = FRMVECTOR3(rx0, ry1, rz0);
    FRMVECTOR3 Temp011 = FRMVECTOR3(rx0, ry1, rz1);
    FRMVECTOR3 Temp100 = FRMVECTOR3(rx1, ry0, rz0);
    FRMVECTOR3 Temp101 = FRMVECTOR3(rx1, ry0, rz1);
    FRMVECTOR3 Temp110 = FRMVECTOR3(rx1, ry1, rz0);
    FRMVECTOR3 Temp111 = FRMVECTOR3(rx1, ry1, rz1);
    FLOAT32 a0 = FrmLerp(sx, FrmVector3Dot(m_g3[b00 + bz0], Temp000), FrmVector3Dot(m_g3[b10 + bz0], Temp100));
    FLOAT32 b0 = FrmLerp(sx, FrmVector3Dot(m_g3[b01 + bz0], Temp010), FrmVector3Dot(m_g3[b11 + bz0], Temp110));
    FLOAT32 c0 = FrmLerp(sy, a0, b0);

    FLOAT32 a1 = FrmLerp(sx, FrmVector3Dot(m_g3[b00 + bz1], Temp001), FrmVector3Dot(m_g3[b10 + bz1], Temp101));
    FLOAT32 b1 = FrmLerp(sx, FrmVector3Dot(m_g3[b01 + bz1], Temp011), FrmVector3Dot(m_g3[b11 + bz1], Temp111));
